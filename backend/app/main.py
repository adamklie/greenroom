...
from app.routers import analytics, apple_music, audio_files, backup, bootstrap_router, content, dashboard, filebrowser, files, gopro, media, recommendations, reorganize, sessions, setlists, songs, sync, tags, trash, triage, upload
